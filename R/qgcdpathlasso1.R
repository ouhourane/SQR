qgcdpathlasso1 <- function(x, y, nlam, flmin, ulam, isd, 
    eps, dfmax, pmax, jd, pf, pf2, maxit, lam2, c, taux, nobs, nvars, 
    vnames) {
    #################################################################################
    #data setup
    y <- as.numeric(y)
    ...
    #################################################################################
    # call Fortran core
    fit <- .Fortran("quantilelassoNET1", c, taux, lam2, nobs, nvars, 
